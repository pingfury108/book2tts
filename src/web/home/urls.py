...
urlpatterns = [
    ...
    path("audio/<str:segment_type>/<int:segment_id>/", views.audio_detail, name="audio_detail"),
    path("audio/<int:segment_id>/", views.audio_detail_legacy, name="audio_detail_legacy"),
